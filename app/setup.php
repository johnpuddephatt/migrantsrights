...
if (function_exists('acf_add_local_field_group')):
    acf_add_local_field_group([
        ...
        'fields' => [
            [
                ...
                'type' => 'select',
                'instructions' =>
                    'Press the control or command key to select multiple projects',
                'required' => 0,
                'conditional_logic' => 0,
                'wrapper' => [
                    'width' => '',
    ...
    acf_add_local_field_group([
        'key' => 'group_60e8b72153167',
        'title' => 'Area of work',
        'fields' => [
            [
                'key' => 'field_60e8b730b1486',
                'label' => 'Area of work',
                'name' => 'area_of_work',
                'type' => 'taxonomy',
                'instructions' =>
                    'Select an area of work to have tagged posts appear on this page.',
                'required' => 0,
                'conditional_logic' => 0,
                'wrapper' => [
                    'width' => '',
...
add_action(
    ...
    function () {
        ...
        register_taxonomy('workareas', ['post'], $args);
    },
    0
);
...
function add_project_box_html($post)
{
    ...
    <p><a target="_blank" href="<?php echo get_edit_post_link(
        $related_post->ID
    ); ?>" title="<?php echo $related_post->post_title; ?>"><?php echo substr(
