    ...
    <div class="container pt-32 pb-20 ">
      <div class="flex flex-wrap order-first gap-8 text-center md:text-left">
        <div class="flex-shrink w-full mt-3 lg:w-1/6 md:w-1/2">
          <a class="flex items-center justify-center font-medium lg:-mt-6 title-font md:justify-start">
            <img class="w-1/2 h-auto lg:w-full" src="{{ $siteLogo }}" />
          </a>
        </div>
        <div class="flex-shrink w-full mr-auto lg:mt-0 xl:w-1/3 lg:w-1/4">
          ...
          <p class="mb-2 text-sm site-footer--address contact-address">{!!
            nl2br(strip_tags(get_theme_mod('contact_address')))
            !!}</p>
          @endif
          @if(get_theme_mod('contact_email'))
          <p class="text-sm"><a class="site-footer--email contact-email"
          ...
          <p class="text-sm"><a class="site-footer--phone contact-phone"
